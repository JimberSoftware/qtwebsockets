...
public:
    ...
    void clientJob(const QByteArray &input, QByteArray &output) override;
    void serverJob(const QByteArray &input, QByteArray &output) override;
    ...
    bool negotiate(const QString &input, QString &output) const override;
